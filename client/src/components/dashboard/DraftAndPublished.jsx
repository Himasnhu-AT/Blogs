...
import Sidebar from "./SideProfile";
...
function Draft(props) {
  ...
  return (
    <div className="min-h-screen bg-custom-black flex flex-col">
      <Navbar />
      <div className="flex flex-1 overflow-hidden ml-12 mt-12">
        <Sidebar />
        <main className="flex-1 overflow-y-auto p-4 sm:p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div>
              {blogs
                .filter((blog) => activeTab === "Draft" ? blog.review !== "approved" : blog.review === "approved")
                .map((blog) => (
                  <div
                    key={blog._id}
                      ...
                      <div className="sm:w-2/3 pt-6 pl-6">
                        ...
                        <div className="flex items-center">
                          <span className="text-gray-500 text-sm font-mono">
                            {activeTab === "Draft" ? "last edited" : "published"} {new Date(blog.date).toLocaleDateString()}
                          </span>
                          <a href="/UpdatePost">
